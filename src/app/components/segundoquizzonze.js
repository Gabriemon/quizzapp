...
export default function SecondOnze({ setCurrentPage, currentState, setCurrentState }) {
      ...
      <div className="flex items-center justify-center h-screen">
          ...
          <div className="flex justify-center p-10">
             <div className="flex justify-center"> 
                <button onClick={ResultOnze} className="bg-customyellow font-bold py-10 px-10 rounded text-black text-2xl">Continuar</button>
              </div>
              </div>
              </div>
          </div>
